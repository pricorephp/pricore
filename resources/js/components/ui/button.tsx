...
const buttonVariants = cva(
    "inline-flex items-center cursor-pointer justify-center gap-1.5 whitespace-nowrap rounded-lg font-medium transition-all duration-150 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 [&_svg]:shrink-0 outline-none focus-visible:ring-ring/50 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
    {
        variants: {
            variant: {
                default:
                ...
                success:
                    'bg-gradient-to-b from-button-success-from to-button-success-to border border-b-2 border-button-success-border text-white shadow-sm [text-shadow:0_1px_0_rgba(0,0,0,0.2)] hover:from-button-success-to hover:to-button-success-to active:scale-[0.98]',
                outline:
