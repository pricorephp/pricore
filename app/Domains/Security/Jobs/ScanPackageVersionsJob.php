...
class ScanPackageVersionsJob implements ShouldQueue
{
    ...
    public function handle(
        ...
        $this->notifyAdmins($matchesCreated);
    }

    protected function notifyAdmins(int $matchesCreated): void
    {
        $organization = $this->package->organization;

        // Get severity counts for the new matches
